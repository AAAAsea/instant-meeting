...
class Pen extends Tool {
    ...
    protected saveImageData?: ImageData;
    protected previousPos: Point = {
        x: 0,
        y: 0
    };
    protected operateStart(pos: Point) {
        ...
        if(this.drawColorType === ColorType.MAIN){
          Tool.ctx.strokeStyle = Tool.mainColor;
        }else if(this.drawColorType === ColorType.SUB){
          Tool.ctx.strokeStyle = Tool.subColor;
        }else{
          Tool.ctx.strokeStyle = Tool.eraserColor;
        }
